...
class DisplayComponent(Component):
	...
	blankLine: str = " " * Constants.Hardware.NUM_CHARS_PER_DISPLAY_LINE

	################################################################################################################

	class Displays:
		def __init__(self):
			self._tl: str = DisplayComponent.blankLine
			self._bl: str = DisplayComponent.blankLine
			self._tr: str = DisplayComponent.blankLine
			self._br: str = DisplayComponent.blankLine

		def rows_as_list(self) -> list[str]:
	...
	def __init__(self, control_surface, name='DisplayComponent', *a, **k):
		...
		self._currentDisplay: DisplayComponent.Displays = DisplayComponent.Displays()
		# Memory for displaying popups.
		self._cachedDisplay: DisplayComponent.Displays = DisplayComponent.Displays()
		# Tell the display the data has changed so can update.
		self._dirty: bool = False # Start dirty and upload at least once.
